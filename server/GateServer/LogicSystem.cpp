...
LogicSystem::LogicSystem() {
	...
	RegGet("/", [](std::shared_ptr<HttpConnection> connection) {
		...
		root["endpoints"].append("/get_test");
		root["endpoints"].append("/get_varifycode");
		root["endpoints"].append("/user_register");
		root["endpoints"].append("/user_login");
		root["endpoints"].append("/reset_pwd");
